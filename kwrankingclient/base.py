...
class BaseClientManager(object):
    ...
    """
    def __init__(self, kwranking_url, auth_token):
        self.kwranking_url = kwranking_url
        self.auth_token = auth_token

    USER_AGENT = 'python-kwrankingclient'

    def _get(self, url, response_key):
        """Sends get request to Kwranking.

        :param url: URL to the wanted Kwranking resource.
        :type url: str
    ...
    def _create(self, url, body, response_key):
        """Sends create request to Kwranking.
    ...
    def _delete(self, url):
        """Sends delete request to Kwranking.
    ...
    def _update(self, url, body, response_key=None):
        """Sends update request to Kwranking.
    ...
    def request(self, url, method, **kwargs):
        ...
        resp = requests.request(method, self.kwranking_url + url, **kwargs)
        ...
        if resp.status_code >= 400:
            ...
            raise exception.KwrankingClientException(body, code=resp.status_code)
