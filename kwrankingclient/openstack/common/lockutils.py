...
from kwrankingclient.openstack.common import fileutils
from kwrankingclient.openstack.common.gettextutils import _
from kwrankingclient.openstack.common import log as logging
...
util_opts = [
    ...
    cfg.StrOpt('lock_path',
               default=os.environ.get("KWRANKINGCLIENT_LOCK_PATH"),
...
def main(argv):
    ...
    os.environ["KWRANKINGCLIENT_LOCK_PATH"] = lock_dir
    try:
